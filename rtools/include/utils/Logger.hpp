...
namespace Ruby
{
    ...
    public:
        ...
        using LoggerPtr = std::shared_ptr<Tx>;


        static Logger& GetInstance(void);

        LoggerPtr<LoggerTraits::VendorLogger> MakeLog(void) const;
    ...
    private:
        ...
        LoggerPtr<LoggerTraits::VendorLogger> m_logger = nullptr;
    };


    void init(RubyString&& path="RubyLog", RubyString&& coreName="RubyCore");
}
